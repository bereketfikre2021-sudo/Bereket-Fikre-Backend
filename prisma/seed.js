...
async function main() {
  ...
  const projects = [
    ...
    { slug:'full-brand-identity-swan-clothing',              title:'Full Brand Identity - Swan Clothing',                             category:'brand-identity-design',           shortDescription:'Complete brand identity for a modern fashion brand.',                     fullDescription:'Complete brand identity package including logo design, product packaging mockups, and comprehensive brand guidelines for a modern fashion brand.',           technologies:['Adobe Illustrator','Adobe Photoshop'],            status:'PUBLISHED', featured:false, displayOrder:1  },
    { slug:'full-brand-identity-dayer-engineering',          title:'Full Brand Identity - Dayer Engineering PLC',                     category:'brand-identity-design',           shortDescription:'Comprehensive brand identity system for an engineering company.',         fullDescription:'Comprehensive brand identity system including logo design, brand guidelines, and corporate materials for an engineering company.',                         technologies:['Adobe Illustrator','Adobe InDesign'],             status:'PUBLISHED', featured:false, displayOrder:2  },
    { slug:'brand-identity-maleda-coffee',                   title:'Brand Identity - Maleda Coffee',                                  category:'brand-identity-design',           shortDescription:'Premium coffee brand identity with rich visual storytelling.',             fullDescription:'Premium coffee brand identity with rich visual storytelling, packaging design, and complete brand experience from bean to cup.',                           technologies:['Adobe Illustrator','Adobe Photoshop'],            status:'PUBLISHED', featured:false, displayOrder:3  },
    { slug:'company-logo-rebranding-alta-counseling',        title:'Company Logo Rebranding - Alta Counseling Ethiopia',               category:'brand-identity-design',           shortDescription:'Complete brand identity and logo rebranding for Alta Counseling Ethiopia.', fullDescription:'Complete brand identity and logo rebranding including refreshed logo design, brand guidelines, and visual identity system.',                                technologies:['Adobe Illustrator'],                              status:'PUBLISHED', featured:false, displayOrder:4  },
    { slug:'full-brand-identity-raya-hotel',                 title:'Full Brand Identity - Raya Hotel & Convention Center',             category:'brand-identity-design',           shortDescription:'Comprehensive brand identity system for a hospitality and convention center.', fullDescription:'Comprehensive brand identity system including logo design, brand guidelines, visual identity, color palette, typography, and complete brand applications.', technologies:['Adobe Illustrator','Adobe Photoshop','Adobe InDesign'], status:'PUBLISHED', featured:false, displayOrder:5  },
    { slug:'brand-identity-medavail-pharmaceutical',         title:'Brand Identity - Medavail Pharmaceutical Import & Wholesale',      category:'brand-identity-design',           shortDescription:'Brand identity to strengthen credibility and professional market presence.', fullDescription:'Brand identity development for Medavail Pharmaceutical Import & Wholesale to strengthen credibility, recognition, and professional market presence.',    technologies:['Adobe Illustrator','Adobe InDesign'],             status:'PUBLISHED', featured:false, displayOrder:6  },
    { slug:'brand-identity-basha-bekele-coffee',             title:'Brand Identity - Basha Bekele Specialty Coffee',                   category:'brand-identity-design',           shortDescription:'Brand identity to communicate quality, origin, and premium export positioning.', fullDescription:'Brand identity for Basha Bekele Specialty Coffee Producer & Exporter, crafted to communicate quality, origin, and a premium export-ready brand presence.',technologies:['Adobe Illustrator','Adobe Photoshop'],            status:'PUBLISHED', featured:false, displayOrder:7  },
    { slug:'brand-identity-digital-deresegn',                title:'Brand Identity - Digital Deresegn',                                category:'brand-identity-design',           shortDescription:'Complete visual identity direction including brand look-and-feel and adaptable assets.', fullDescription:'Complete visual identity direction for Digital Deresegn, including brand look-and-feel, design consistency, and adaptable brand assets.',         technologies:['Adobe Illustrator','Figma'],                      status:'PUBLISHED', featured:false, displayOrder:8  },
    { slug:'brand-identity-criterion-home-care',             title:'Brand Identity - Criterion In Home Care (USA)',                    category:'brand-identity-design',           shortDescription:'Professional brand identity focused on trust, care, and clean visual system.', fullDescription:'Professional brand identity for Criterion In Home Care (USA) focused on trust, care, and a clean visual system for service communication.',            technologies:['Adobe Illustrator','Adobe InDesign'],             status:'PUBLISHED', featured:false, displayOrder:9  },

    // ── PRINT & MARKETING (service: print-design) ────────────────────────────
    { slug:'a5-flyer-design-ptgr',                           title:'A5 Flyer Design - PTGR',                                          category:'print-design',                    shortDescription:'Professional A5 flyer design featuring modern layouts and compelling visuals.', fullDescription:'Professional A5 flyer design featuring modern layouts, compelling visuals, and clear messaging for marketing campaigns.',                                technologies:['Adobe Photoshop','Adobe Illustrator'],            status:'PUBLISHED', featured:false, displayOrder:10 },
    { slug:'business-card-design-digital-deresegn',          title:'Business Card Design - Digital Deresegn',                          category:'print-design',                    shortDescription:'Professional business card with clean, brand-consistent layout.',          fullDescription:'Professional business card design for Digital Deresegn with a clean, brand-consistent layout optimized for clear contact communication.',               technologies:['Adobe Illustrator','Adobe InDesign'],             status:'PUBLISHED', featured:false, displayOrder:11 },
    { slug:'flyer-design-digital-deresegn',                  title:'Flyer Design - Digital Deresegn',                                  category:'print-design',                    shortDescription:'Marketing flyer focused on strong hierarchy and visual impact.',            fullDescription:'Marketing flyer design for Digital Deresegn focused on strong hierarchy, clear messaging, and visual impact for campaign distribution.',                technologies:['Adobe Photoshop','Adobe Illustrator'],            status:'PUBLISHED', featured:false, displayOrder:12 },
    { slug:'employee-id-design-prime-ethiopia',              title:'Employee ID Design - Prime Ethiopia',                               category:'print-design',                    shortDescription:'Professional employee ID card design with clear layout and print-ready specifications.', fullDescription:'Professional employee ID card design for Prime Ethiopia, featuring clear layout, branding, and print-ready specifications for corporate identification.',technologies:['Adobe InDesign','Adobe Illustrator'],             status:'PUBLISHED', featured:false, displayOrder:13 },
    { slug:'prime-ethiopia-business-proposal',               title:'Prime Ethiopia Business Proposal Cover',                           category:'print-design',                    shortDescription:'Professional business proposal cover with modern layout and corporate branding.', fullDescription:'Professional business proposal cover design for Prime Ethiopia, featuring modern layout and corporate branding for company proposal documents.',       technologies:['Adobe InDesign','Adobe Illustrator'],             status:'PUBLISHED', featured:false, displayOrder:14 },

    // ── BRAND APPLICATIONS (service: brand-applications-assets) ──────────────
    { slug:'rollup-banner-yat-business-group',               title:'Rollup Banner Design - YAT Business Group',                        category:'brand-applications-assets',       shortDescription:'Professional rollup banner mockup for exhibitions and corporate events.',    fullDescription:'Professional rollup banner mockup design for exhibitions and corporate events, showcasing brand identity and messaging.',                               technologies:['Adobe Illustrator','Adobe Photoshop'],            status:'PUBLISHED', featured:false, displayOrder:15 },

    // ── DIGITAL / WEB (service: digital-social-media-design) ─────────────────
    { slug:'website-banner-design-finix-bet-1',              title:'Website Banner Design - Finix Bet',                                category:'digital-social-media-design',     shortDescription:'Professional website banner optimized for web display and digital marketing.', fullDescription:'Professional website banner design for Finix Bet, optimized for web display and digital marketing campaigns.',                                          technologies:['Adobe Photoshop'],                               status:'PUBLISHED', featured:false, displayOrder:16 },
    { slug:'website-banner-collection-finix-bet-2',          title:'Website Banner Collection - Finix Bet (Series 2)',                 category:'digital-social-media-design',     shortDescription:'Website banner featuring modern layouts and engaging visuals.',             fullDescription:'Website banner design featuring modern layouts and engaging visuals for effective online presence.',                                                   technologies:['Adobe Photoshop'],                               status:'PUBLISHED', featured:false, displayOrder:17 },
    { slug:'web-banner-design-finix-bet-3',                  title:'Web Banner Design - Finix Bet (Series 3)',                         category:'digital-social-media-design',     shortDescription:'Professional web banner optimized for various screen sizes and digital platforms.', fullDescription:'Professional web banner design optimized for various screen sizes and digital platforms.',                                                         technologies:['Adobe Photoshop'],                               status:'PUBLISHED', featured:false, displayOrder:18 },
    { slug:'website-banner-series-finix-bet-4',              title:'Website Banner Series - Finix Bet (Series 4)',                     category:'digital-social-media-design',     shortDescription:'Comprehensive website banner series for consistent brand communication.',    fullDescription:'Comprehensive website banner series designed for consistent brand communication across digital platforms.',                                             technologies:['Adobe Photoshop'],                               status:'PUBLISHED', featured:false, displayOrder:19 },
    { slug:'web-banner-assets-finix-bet-5',                  title:'Web Banner Assets - Finix Bet (Series 5)',                         category:'digital-social-media-design',     shortDescription:'Professional web banner assets featuring modern design for digital marketing.', fullDescription:'Professional web banner assets featuring modern design and engaging visuals for digital marketing.',                                                   technologies:['Adobe Photoshop'],                               status:'PUBLISHED', featured:false, displayOrder:20 },
    { slug:'website-banner-collection-finix-bet-10',         title:'Website Banner Collection - Finix Bet (Series 10)',                category:'digital-social-media-design',     shortDescription:'Engaging website banner collection for digital marketing.',                 fullDescription:'Engaging website banner collection featuring modern design and compelling visuals for digital marketing.',                                              technologies:['Adobe Photoshop'],                               status:'PUBLISHED', featured:false, displayOrder:21 },

    // ── SOCIAL MEDIA (service: marketing-campaign-design) ────────────────────
    { slug:'karaoke-event-social-media-blu-hart',            title:'Karaoke Event Social Media - Blu Hart',                            category:'marketing-campaign-design',       shortDescription:'Social media design collection for a karaoke event to drive attendance.',   fullDescription:'Social media design collection for a karaoke event, featuring engaging posts and promotional graphics to drive event attendance and engagement.',      technologies:['Adobe Photoshop','Figma'],                        status:'PUBLISHED', featured:false, displayOrder:22 },
    { slug:'social-media-design-ace-stainless-steel',        title:'Social Media Design - Ace Stainless Steel',                        category:'marketing-campaign-design',       shortDescription:'Professional social media design showcasing products and services.',         fullDescription:'Professional social media design collection for a stainless steel manufacturing company, showcasing products and services.',                          technologies:['Adobe Photoshop','Figma'],                        status:'PUBLISHED', featured:false, displayOrder:23 },
    { slug:'social-media-design-awra-designs',               title:'Social Media Design - Awra Designs',                               category:'marketing-campaign-design',       shortDescription:'Professional social media collection for digital marketing campaigns.',       fullDescription:'Professional social media design collection for Awra Designs, featuring engaging posts and promotional graphics for digital marketing campaigns.',     technologies:['Adobe Photoshop','Figma'],                        status:'PUBLISHED', featured:false, displayOrder:24 },
    { slug:'social-media-post-digital-deresegn',             title:'Social Media Post Design - Digital Deresegn',                      category:'marketing-campaign-design',       shortDescription:'Social media post for brand consistency and campaign-ready publishing.',     fullDescription:'Social media post design for Digital Deresegn built for brand consistency, strong engagement, and campaign-ready digital publishing.',                technologies:['Adobe Photoshop','Figma'],                        status:'PUBLISHED', featured:false, displayOrder:25 },
    { slug:'social-media-graphics-niqat-coffee',             title:'Social Media Graphics Collection - Niqat Coffee',                  category:'marketing-campaign-design',       shortDescription:'Comprehensive social media graphics for digital marketing campaigns.',       fullDescription:'Comprehensive collection of social media graphics designed for various digital marketing campaigns and promotions.',                                    technologies:['Adobe Photoshop','Figma'],                        status:'PUBLISHED', featured:false, displayOrder:26 },
    { slug:'social-media-design-prime-ethiopia',             title:'Social Media Design - Prime Ethiopia',                             category:'marketing-campaign-design',       shortDescription:'Professional social media collection for digital marketing campaigns.',       fullDescription:'Professional social media design collection for Prime Ethiopia, featuring engaging posts and promotional graphics for digital marketing campaigns.',   technologies:['Adobe Photoshop','Figma'],                        status:'PUBLISHED', featured:false, displayOrder:27 },
    { slug:'social-media-design-prime-ethiopia-2',           title:'Social Media Design For Prime Ethiopia (Campaign)',                 category:'marketing-campaign-design',       shortDescription:'Campaign social media visual for strong reach and consistent brand presentation.', fullDescription:'Campaign social media visual for Prime Ethiopia designed for strong reach, fast readability, and consistent brand presentation.',                    technologies:['Adobe Photoshop','Figma'],                        status:'PUBLISHED', featured:false, displayOrder:28 },
    { slug:'social-media-template-task-plug',                title:'Social Media Template Series - Task Plug',                         category:'marketing-campaign-design',       shortDescription:'Social media template with promotional graphics for digital marketing.',     fullDescription:'Additional social media template design featuring promotional graphics and engaging visual content for digital marketing.',                            technologies:['Adobe Photoshop','Figma'],                        status:'PUBLISHED', featured:false, displayOrder:29 },

    // ── CREATIVE DIRECTION (service: art-direction-visual-guidance) ───────────
    { slug:'creative-direction-visual-guidance-1',           title:'Creative Direction & Visual Guidance - Project 1',                 category:'art-direction-visual-guidance',   shortDescription:'Comprehensive creative direction for product presentation and brand assets.', fullDescription:'Comprehensive creative direction and visual guidance for product presentation, photography, and creative assets across multiple touchpoints.',         technologies:['Adobe Creative Suite'],                          status:'PUBLISHED', featured:false, displayOrder:30 },
    { slug:'creative-direction-visual-guidance-2',           title:'Creative Direction & Visual Guidance - Project 2',                 category:'art-direction-visual-guidance',   shortDescription:'Professional creative direction for campaigns and brand storytelling.',       fullDescription:'Professional creative direction and visual guidance for creative campaigns and brand storytelling, including photography and video production guidance.',technologies:['Adobe Creative Suite'],                          status:'PUBLISHED', featured:false, displayOrder:31 },
    { slug:'creative-direction-visual-guidance-3',           title:'Creative Direction & Visual Guidance - Project 3',                 category:'art-direction-visual-guidance',   shortDescription:'Strategic creative direction for product launches and marketing initiatives.', fullDescription:'Strategic creative direction for product launches and marketing initiatives, including visual guidelines for product photography.',                    technologies:['Adobe Creative Suite'],                          status:'PUBLISHED', featured:false, displayOrder:32 },
    { slug:'creative-direction-visual-guidance-4',           title:'Creative Direction & Visual Guidance - Project 4',                 category:'art-direction-visual-guidance',   shortDescription:'Comprehensive creative direction for brand campaigns and visual communication.', fullDescription:'Comprehensive creative direction for brand campaigns and visual communication, encompassing concepts, style guides, and direction for photo/video teams.', technologies:['Adobe Creative Suite'],                         status:'PUBLISHED', featured:false, displayOrder:33 },
    { slug:'creative-direction-visual-guidance-5',           title:'Creative Direction & Visual Guidance - Project 5',                 category:'art-direction-visual-guidance',   shortDescription:'Professional creative direction for digital and print marketing materials.',   fullDescription:'Professional creative direction for digital and print marketing materials, including social media content, advertising campaigns, and promotional materials.', technologies:['Adobe Creative Suite'],                        status:'PUBLISHED', featured:false, displayOrder:34 },
    { slug:'creative-direction-visual-guidance-6',           title:'Creative Direction & Visual Guidance - Project 6',                 category:'art-direction-visual-guidance',   shortDescription:'Strategic creative direction for brand campaigns and visual storytelling.',    fullDescription:'Strategic creative direction for brand campaigns and visual storytelling, directing creative teams and ensuring brand consistency across all visual touchpoints.', technologies:['Adobe Creative Suite'],                       status:'PUBLISHED', featured:false, displayOrder:35 },
    ...
    { slug:'flyer-design-prime-ethiopia',                    title:'Flyer Design - Prime Ethiopia',                                    category:'print-design',                    shortDescription:'Professional flyer featuring compelling visuals for marketing campaigns.',     fullDescription:'Professional flyer design for Prime Ethiopia, featuring compelling visuals and clear messaging for marketing campaigns.',                               technologies:['Adobe Photoshop','Adobe Illustrator'],            status:'PUBLISHED', featured:true,  displayOrder:36 },
    { slug:'premium-coffee-packaging-toco',                  title:'Premium Coffee Packaging - Toco Speciality Coffee',                category:'brand-applications-assets',       shortDescription:'Premium packaging combining visual appeal with functional design.',           fullDescription:'Premium packaging design for Toco Speciality Coffee, combining visual appeal with functional design for retail and distribution.',                     technologies:['Adobe Illustrator','Adobe Photoshop'],            status:'PUBLISHED', featured:true,  displayOrder:37 },
    { slug:'rollup-banner-toco-coffee',                      title:'Rollup Banner - Toco Speciality Coffee',                           category:'brand-applications-assets',       shortDescription:'Professional rollup banner for exhibitions and retail environments.',          fullDescription:'Professional rollup banner design for Toco Speciality Coffee, showcasing brand identity for exhibitions and retail environments.',                     technologies:['Adobe Illustrator'],                              status:'PUBLISHED', featured:true,  displayOrder:38 },
    { slug:'trifold-brochure-ptgr',                          title:'Trifold Brochure - PTGR',                                          category:'print-design',                    shortDescription:'Professional trifold brochure featuring modern layouts for marketing materials.', fullDescription:'Professional trifold brochure design for PTGR, featuring modern layouts and engaging visual content for marketing materials.',                        technologies:['Adobe InDesign','Adobe Illustrator'],             status:'PUBLISHED', featured:true,  displayOrder:39 },
    { slug:'company-profile-cci-utop-goozam',                title:'Company Profile - CCI, Utop & Goozam Technologies',                category:'print-design',                    shortDescription:'Professional company profile for print and digital use.',                     fullDescription:'Professional company profile design for CCI, Utop and Goozam Technologies, showcasing brand identity, services, and corporate messaging.',             technologies:['Adobe InDesign','Adobe Illustrator'],             status:'PUBLISHED', featured:true,  displayOrder:40 },
    { slug:'course-outline-cci-usa',                         title:'Course Outline - Center For Computer Intelligence (CCI)',           category:'print-design',                    shortDescription:'Professional course outline design for educational materials.',               fullDescription:'Professional course outline design for Center For Computer Intelligence (CCI) USA, featuring clear structure and engaging layout for educational materials.', technologies:['Adobe InDesign'],                             status:'PUBLISHED', featured:true,  displayOrder:41 },
  ];

  for (const p of projects) {
    const ex = await prisma.project.findUnique({ where: { slug: p.slug } });
    if (!ex) {
      ...
      console.log(`ℹ️  Project exists: ${p.title}`);
    }
  }
